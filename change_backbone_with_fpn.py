...
def create_model(num_classes):
    ...
    backbone = torchvision.models.efficientnet_v2_m(pretrained=True)
    # print(backbone)
    return_layers = {"features.2": "0",  # stride 8
                     "features.3": "1",  # stride 16
                     "features.8": "3"}  # stride 32
    # 提供给fpn的每个特征层channely
    # EV2_s in_channels_list = [48, 64, 1280]
