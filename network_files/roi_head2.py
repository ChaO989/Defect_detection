...
class RoIHeads(torch.nn.Module):
    ...
    def forward(self,
        ...
        box_featuresreg, box_featurescls = self.box_head(box_features)
        # box_featuresreg = self.box_headreg(box_features)

        # 接着分别预测目标类别和边界框回归参数
        class_logits, box_regression = self.box_predictor(box_featuresreg, box_featurescls)
        # box_regression = self.box_predictorreg(box_featuresreg)
